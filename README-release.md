...
|-------------------------------------------------------------------------|--------|----------|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    <a name="input_config_file"></a>[config_file](#input_config_file)    | string |  false   |  `"release-please-config.json"`   |                                              Path to release-please-config.json. Must be <br>used together with release_type=manifest for <br>this to have any effect                                               |
| <a name="input_manifest_file"></a>[manifest_file](#input_manifest_file) | string |  false   | `".release-please-manifest.json"` |                                            Path to .release-please-manifest.json. Must be <br>used together with release_type=manifest for <br>this to have any effect                                              |
...
|  <a name="input_release_type"></a>[release_type](#input_release_type)   | string |  false   |            `"simple"`             | The type of release to <br>create (simple, terraform-module, helm, maven, manifest, etc). If set to <br>'manifest', you can configure the <br>workflow by setting config_file and <br>manifest_file appropriately.  |
| <a name="input_target_branch"></a>[target_branch](#input_target_branch) | string |  false   |             `"main"`              |                                                                                                                                                                                                                     |
